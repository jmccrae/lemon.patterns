...
/* Category */
    ...
    def visit(p : Absyn.EAbessive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("abessiveCase"))
    def visit(p : Absyn.EAblative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("ablativeCase"))
    def visit(p : Absyn.EAbsolutive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("absolutiveCase"))
    def visit(p : Absyn.EAccusative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("accusativeCase"))
    def visit(p : Absyn.EAdessive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("adessiveCase"))
    def visit(p : Absyn.EAditive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("aditiveCase"))
    def visit(p : Absyn.EAllative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("allativeCase"))
    def visit(p : Absyn.EBenefactive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("benefactiveCase"))
    def visit(p : Absyn.ECausative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("causativeCase"))
    def visit(p : Absyn.EComitative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("comitativeCase"))
    def visit(p : Absyn.EDative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("dativeCase"))
    def visit(p : Absyn.EDelative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("delativeCase"))
    def visit(p : Absyn.EElative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("elativeCase"))
    def visit(p : Absyn.EEquative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("equativeCase"))
    def visit(p : Absyn.EErgative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("ergativeCase"))
    def visit(p : Absyn.EEssive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("essiveCase"))
    def visit(p : Absyn.EGenitive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("genitiveCase"))
    def visit(p : Absyn.EIllative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("illativeCase"))
    def visit(p : Absyn.EInessive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("inessiveCase"))
    def visit(p : Absyn.EInstrumental, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("instrumentalCase"))
    def visit(p : Absyn.ELative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("lativeCase"))
    def visit(p : Absyn.ELocative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("locativeCase"))
    def visit(p : Absyn.ENominative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("nominativeCase"))
    def visit(p : Absyn.EOblique, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("obliqueCase"))
    def visit(p : Absyn.EPartitive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("partitiveCase"))
    def visit(p : Absyn.EProlative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("prolativeCase"))
    def visit(p : Absyn.ESociative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("sociativeCase"))
    def visit(p : Absyn.ESublative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("sublativeCase"))
    def visit(p : Absyn.ESuperessive, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("superessiveCase"))
    def visit(p : Absyn.ETerminative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("terminativeCase"))
    def visit(p : Absyn.ETranslative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("translativeCase"))
    def visit(p : Absyn.EVocative, arg : collection.mutable.Map[String,String]) = (lexinfo("case"),lexinfo("vocativeCase"))
