...
public class EPNPSimple extends PNP {
  public final String string_;

  public EPNPSimple(String p1) { string_ = p1; }

  public <R,A> R accept(net.lemonmodel.patterns.parser.Absyn.PNP.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof net.lemonmodel.patterns.parser.Absyn.EPNPSimple) {
      net.lemonmodel.patterns.parser.Absyn.EPNPSimple x = (net.lemonmodel.patterns.parser.Absyn.EPNPSimple)o;
