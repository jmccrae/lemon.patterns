...
public class EVPSimple extends VP {
  public final String string_;

  public EVPSimple(String p1) { string_ = p1; }

  public <R,A> R accept(net.lemonmodel.patterns.parser.Absyn.VP.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof net.lemonmodel.patterns.parser.Absyn.EVPSimple) {
      net.lemonmodel.patterns.parser.Absyn.EVPSimple x = (net.lemonmodel.patterns.parser.Absyn.EVPSimple)o;
