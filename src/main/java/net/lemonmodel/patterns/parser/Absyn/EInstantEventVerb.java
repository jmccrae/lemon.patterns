...
public class EInstantEventVerb extends VerbPattern {
  public final VerbPattern verbpattern_;

  public EInstantEventVerb(VerbPattern p1) { verbpattern_ = p1; }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof net.lemonmodel.patterns.parser.Absyn.EInstantEventVerb) {
      net.lemonmodel.patterns.parser.Absyn.EInstantEventVerb x = (net.lemonmodel.patterns.parser.Absyn.EInstantEventVerb)o;
